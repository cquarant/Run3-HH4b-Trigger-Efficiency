...
cat JEC_JER_PreBPix.txt >> Making_Histo_$input.C
echo ' TFile *f = new TFile("Histograms_'$input'.root","RECREATE");' >> Making_Histo_$input.C
echo '' >> Making_Histo_$input.C
cat histos.txt    >> Making_Histo_$input.C
echo 'TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PreBPix/'$input'.root");' >> Making_Histo_$input.C
echo '' >> Making_Histo_$input.C
