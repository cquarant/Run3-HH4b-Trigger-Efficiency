...
void Making_Tree_Zto2Q_4Jets_HT_800toInf()
{
...
*/
 ...
 TFile *f = new TFile("Histograms_Zto2Q_4Jets_HT_800toInf.root","RECREATE");
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/Zto2Q_4Jets_HT_800toInf.root");
...
// ********************************************************** weight
   ...
   weight = (weight/SumGenWeights)*XSec_Zto2Q_4Jets_HT_800toInf*Lumi;
