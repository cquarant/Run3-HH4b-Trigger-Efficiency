...
void Making_Tree_GluGlutoHHto4B()
{
...
// *********************************************************
*/
 TFile *f = new TFile("Histograms_GluGlutoHHto4B.root","RECREATE");
...
// **************************************************** Output Tree END
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/GluGlutoHHto4B.root");
...
// ********************************************************** weight
   ...
   weight = (weight/SumGenWeights)*XSec_GluGlutoHHto4B*Lumi;
