...
void Making_Tree_QCD_HT_100to200()
{
...
// **************************************************** Output Tree END
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/QCD_HT_100to200.root");
...
// ********************************************************** weight
   ...
   weight = (weight/SumGenWeights)*XSec_QCD_HT_100to200*Lumi;
