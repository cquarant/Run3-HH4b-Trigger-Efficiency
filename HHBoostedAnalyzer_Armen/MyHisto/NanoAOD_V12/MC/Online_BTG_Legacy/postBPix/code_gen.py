...
def get_root_file_path(HT_low: str, HT_high: str) -> str:
    ...
    # /eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/QCD_HT_{HT_low}to{HT_high}.root
    file_path = EOS_DATA_BASE / f"Legacy/PostBPix/QCD_HT_{HT_low}to{HT_high}.root"
