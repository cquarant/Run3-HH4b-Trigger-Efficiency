...
double PU_Rew[100] = {
    ...
    0.0560634, 1,         1,          1};
// ********************** PT-Mass-SFs **************************
std::string pf_path = getCMSSWBase() + "/src/Trigger_SFs/PT_Mass_SF_QCD/PT_Mass_2dSF_PostBPix.root";
TFile *f_PT_Mass_SF =
    new TFile(
        // "/afs/cern.ch/user/t/tumasyan/public/2023/Trigger_SFs/PT_Mass_SF_QCD/PT_Mass_2dSF_PostBPix.root");
        pf_path.c_str());
...
void Making_Histo_QCD_HT_1000to1200() {
  ...
  vPar.push_back(JetCorrectorParameters(
      ...
      jec_path + "Summer23BPixPrompt23_V1_MC/"
      "Summer23BPixPrompt23_V1_MC_L2Relative_AK4PFPuppi.txt"));
  ...
  vParAK8.push_back(JetCorrectorParameters(
      // "/afs/cern.ch/user/t/tumasyan/public/2023/JECs/"
      jec_path + "Summer23BPixPrompt23_V1_MC/"
      "Summer23BPixPrompt23_V1_MC_L2Relative_AK8PFPuppi.txt"));
  ...
  */
  ...
  TFile *f1 = new TFile("/eos/cms/store/group/phys_higgs/nonresonant_HH/bbbb/sixie/Run3Analysis/HH/HHTo4BNtupler/ArmenVersion_ICHEP2024/Data_2023/Legacy/PostBPix/QCD_HT_1000to1200.root");
