...
*/
 ...
 TFile *f = new TFile("Histograms_TTto2L2Nu.root","RECREATE");
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/TTto2L2Nu.root");
...
// ********************************************************** weight
   ...
   weight = (weight/SumGenWeights)*XSec_TTto2L2Nu*Lumi;
