...
// ********************** Tau3/2 SFs **************************
  TFile* f_Tau3toTau2   = new TFile("../../Tau3OverTau2_SF.root");
  TH1D * _SF_Tau3toTau2 = (TH1D*)f_Tau3toTau2->Get("SF");
// ********************** TXbb SFs **************************
  TFile* f_Xbb   = new TFile("../../Xbb_SF.root");
...
void Make_TTbar_Corr_Tua3toTau2_and_Xbb()
{
 ...
 TFile *f = new TFile("Histograms_TTbar_Corr_Tua3toTau2and_Xbb.root","RECREATE");
