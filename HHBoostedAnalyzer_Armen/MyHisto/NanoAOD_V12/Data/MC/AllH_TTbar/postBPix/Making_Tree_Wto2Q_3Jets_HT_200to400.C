...
void Making_Tree_Wto2Q_3Jets_HT_200to400()
{
...
*/
 ...
 TFile *f = new TFile("Histograms_Wto2Q_3Jets_HT_200to400.root","RECREATE");
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/Wto2Q_3Jets_HT_200to400.root");
...
// ********************************************************** weight
   ...
   weight = (weight/SumGenWeights)*XSec_Wto2Q_3Jets_HT_200to400*Lumi;
