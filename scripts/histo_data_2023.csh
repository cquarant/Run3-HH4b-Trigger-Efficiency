...
cp ${TMP_DIR}/Histograms_data_${era_tag}_JetMET.root ${OUTPUT_DIR}/Histograms_${era_tag}_data_QCD.root

# Hadd into leptonic channel
target_path=${OUTPUT_DIR}/Histograms_${era_tag}_data_top.root
echo "Hadd into one file: ${target_path}"
hadd -f ${target_path} ${TMP_DIR}/Histograms_data_${era_tag}_Muon.root ${TMP_DIR}/Histograms_data_${era_tag}_EGamma.root

# Hadd into one file (all channels)
target_path=${OUTPUT_DIR}/Histograms_${era_tag}_data.root
echo "Hadd into one file: ${target_path}"
hadd -f ${target_path} ${TMP_DIR}/Histograms_data_${era_tag}.root ${TMP_DIR}/Histograms_data_${era_tag}_JetMET.root