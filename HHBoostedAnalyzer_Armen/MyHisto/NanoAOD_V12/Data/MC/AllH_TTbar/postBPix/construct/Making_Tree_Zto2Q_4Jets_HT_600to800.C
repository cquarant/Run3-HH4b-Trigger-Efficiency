...
// ********************** PT-Mass-SFs **************************
  TFile* f_PT_Mass_SF   = new TFile("/afs/cern.ch/user/t/tumasyan/public/2023/Trigger_SFs/425/PT_Mass_2dSF_425_PostBPix.root");
...
void Making_Tree_Zto2Q_4Jets_HT_600to800()
{
...
*/
 ...
 TFile *f = new TFile("Histograms_Zto2Q_4Jets_HT_600to800.root","RECREATE");
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/Zto2Q_4Jets_HT_600to800.root");
...
// ********************************************************** weight
   ...
   weight = (weight/SumGenWeights)*XSec_Zto2Q_4Jets_HT_600to800*Lumi;
