...
void Make_Histo()
{
  ...
  // TString VAR = "PNetMD_Xbb_Legacy";
  // TString VAR = "PNetMD_Xbb_Legacy_AN";

  // TString XTitle = JET+VAR;
  TString XTitle = "P_{T}^{1}";
  // TString XTitle = "#eta^{1}";
  // TString XTitle = "M_{SD}^{1}";
  // TString XTitle = "X_{bb}^{1}";
  ...
  /* Files*/
  TFile* f_Data   = new TFile("Data/QCD_Data_Trig_Eff_Histo_BTG_"+erA+".root");
  TFile* f_MC    = new TFile("MC/QCD_Trig_Eff_Histo_BTG_"+erA+".root");
