...
TH1D *_FatJet1_HbbvsQCD  = new TH1D("FatJet1_HbbvsQCD","FatJet1_HbbvsQCD",100,0,1.0);
...
TH1D *_FatJet2_HbbvsQCD  = new TH1D("FatJet2_HbbvsQCD","FatJet2_HbbvsQCD",100,0,1.0);
...
TH1D *_FatJet3_HbbvsQCD  = new TH1D("FatJet3_HbbvsQCD","FatJet3_HbbvsQCD",100,0,1.0);
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/PreBPix/TTtoLNu2Q.root");
...
InputTree->SetBranchAddress("fatJet1_particleNetWithMass_HbbvsQCD",&FatJet1_HbbvsQCD);
...
InputTree->SetBranchAddress("fatJet2_particleNetWithMass_HbbvsQCD",&FatJet2_HbbvsQCD);
...
*/
    if(FatJet1_pt < 240 || fabs(FatJet1_eta) > 2.5 || FatJet1_MassSD < 50) continue;
...
// ********************************************************** Fill Histograms
 ...
 _FatJet1_HbbvsQCD ->Fill(FatJet1_HbbvsQCD,weight);
...
if(matched_TRG_1)
 ...
 _FatJet2_HbbvsQCD ->Fill(FatJet1_HbbvsQCD,weight);
 }
...
if(matched_TRG_1 && matched_TRG_2)
 ...
 _FatJet3_HbbvsQCD ->Fill(FatJet1_HbbvsQCD,weight);
 }
