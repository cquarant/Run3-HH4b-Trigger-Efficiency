...
void tree_mc(const std::string &year,      // 2022, 2023
  ...
  Float_t T_fatJet2_pt, T_fatJet2_eta, T_fatJet2_msoftdrop, T_fatJet2_globalParT_XbbVsQCD,
      T_fatJet2_GloParT_XbbVsQCD, T_fatJet2_GloParT_massVis, T_fatJet2_GloParT_massRes,
      T_fatJet2_Tau3OverTau2;
  Float_t T_pTjj;
  ...
  for (int i = 0; i < InputTree->GetEntries(); i++) {
    ...
    // Each jet matched to HLT_AK8PFJet425_SoftDropMass40 trigger
    int trigger_bit = 4;
