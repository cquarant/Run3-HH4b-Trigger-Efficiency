...
void Making_Histo_QCD_PT_170to300()
{
 TFile *f = new TFile("Histograms_QCD_PT_170to300.root","RECREATE");
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/MC/postEE_SFs/QCD_PT_170to300.root");
...
// ********************************************************** weight
   weight = (weight/SumGenWeights)*XSec_QCD_PT_170to300*Lumi;
