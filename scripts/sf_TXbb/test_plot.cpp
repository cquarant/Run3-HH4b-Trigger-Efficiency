...
// **********************************************************************
  ...
  TString PlotTitle="    AK8PFJet250_SoftDropMass40_PFAK8ParticleNetBB0p35    (|#eta| < 2.5)";
...
//  TString probe_var  = "FatJet1PNetHbbvsQCD";
//  TString probeM_var = "FatJet2PNetHbbvsQCD";
//  TString probe_var  = "FatJet1_MassSD";
//  TString probeM_var = "FatJet2_MassSD";
...
//  TString probe_var  = "FatJet2PNetMD_Xbb_Legacy";
//  TString probeM_var = "FatJet3PNetMD_Xbb_Legacy";
//  TString probe_var  = "FatJet2PNetMD_Xbb_Legacy_AN";
//  TString probeM_var = "FatJet3PNetMD_Xbb_Legacy_AN";
//   TString probe_var  = "FatJet2_globalParT_XbbVsQCD";
//   TString probeM_var = "FatJet3_globalParT_XbbVsQCD";
  TString probe_var  = "ProbeJet_all_GloParT_XbbVsQCD";
  TString probeM_var = "ProbeJet_pass_GloParT_XbbVsQCD";

//   TFile* fData = new TFile("Data/TTbar_Data_Trig_Eff_Histo_BTG_"+era+".root");
//   TFile* fMC = new TFile("MC/TTbar_Trig_Eff_Histo_BTG_"+era+".root");
  TFile* fData = new TFile("output/Histograms_2022_data_TTbar.root");
  TFile* fMC = new TFile("output/Histograms_2022_MC_TTbar.root");


/*
// QCD
  TFile* fData = new TFile("Data/QCD_Data_Trig_Eff_Histo_BTG_"+era+".root");
  TFile* fMC = new TFile("MC/QCD_Trig_Eff_Histo_BTG_"+era+".root");
  TString probe_var  = "FatJet1PNetMD_Xbb";
  TString probeM_var = "FatJet2PNetMD_Xbb";
*/
...
//  _MC_ProbeM_pt->GetXaxis()->SetTitle("Probe - X_{bb}");
    _MC_ProbeM_pt->GetXaxis()->SetTitle("Probe - globalParT_XbbVsQCD");
