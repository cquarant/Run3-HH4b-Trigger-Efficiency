...
//  XTitle = "FJet_{1} - #tau_{3} / #tau_{2}";
  ...
  Float_t Bound[8] = {0,50,66,83,100,150,180,250};
  TH1D *_My_Data     = new TH1D("My_Data","My_Data",7,Bound);
  TH1D *_My_qcd       = new TH1D("My_qcd","My_qcd",7,Bound);
  TH1D *_My_tt       = new TH1D("My_tt","My_tt",7,Bound);
  TH1D *_My_vj       = new TH1D("My_vj","My_vj",7,Bound);
  TH1D *_My_vv       = new TH1D("My_vv","My_vv",7,Bound);


// Files
  TFile* f_Data   = new TFile("../Histograms/Signal_Basic/Histograms_Data.root");
  TFile* f_QCD    = new TFile("../Histograms/Signal_Basic/Histograms_QCD.root");
//  TFile* f_TTbar  = new TFile("../Histograms/Signal_Basic/Histograms_TTbar.root");
  TFile* f_TTbar  = new TFile("../Histograms/Signal_Basic/Histograms_TTbar_Corr.root");
  TFile* f_VJ  = new TFile("../Histograms/Signal_Basic/Histograms_VJ.root");
  TFile* f_VV  = new TFile("../Histograms/Signal_Basic/Histograms_VV.root");
...
// ******************************* Legend
    ...
    t1->AddText("#it{                                                                CMS (2023 C-D) preliminary ~ 21.7 fb^{-1}}");
    t1->Draw("same");
