...
void Making_Histo_QCD_PT_3200toInf()
{
 TFile *f = new TFile("Histograms_QCD_PT_3200toInf.root","RECREATE");
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/MC/postEE_SFs/QCD_PT_3200toInf.root");
...
// ********************************************************** weight
   weight = (weight/SumGenWeights)*XSec_QCD_PT_3200toInf*Lumi;
