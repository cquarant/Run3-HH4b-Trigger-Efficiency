...
void Making_Histo_QCD_HT_1500to2000() {
  ...
  */
  ...
  TFile *f1 = new TFile("/eos/cms/store/group/phys_higgs/nonresonant_HH/bbbb/sixie/Run3Analysis/HH/HHTo4BNtupler/ArmenVersion_ICHEP2024/Data_2023/Legacy/PreBPix/QCD_HT_1500to2000.root");
  ...
  std::cout << "Done with Making_Histo_QCD_HT_1500to2000.C" << std::endl;
}
