...
//  Tau3OverTau2_CUT = "With_J1J2_L_Cut/";
...
//  variable="Lep1_Pt";
  ...
  TFile* f_TTbar  = new TFile("MC/"+Tau3OverTau2_CUT+"Histograms_TTbar_Corr.root");
...
// ********************************************************************* SF
   ...
   _SF_pt->SetMarkerSize(1.2);
    ...
    TF1 *Mypol   = new TF1("Mypol","pol3",0.0,1.1);
    _SF_pt->Fit("Mypol","R");

   TH1D * hint   = new TH1D("hint","",185,0.0,1.0);
...
//  hint_68 ->Draw("e3same");
  _SF_pt  ->Draw("e1same");
    ...
    TLegend * leg1 = new TLegend(0.75,0.65,0.95,0.8);
    SetLegendStyle(leg1);
    leg1->SetTextSize(0.1);
    leg1->AddEntry(hint_68,"#sigma","f");
