...
*/
 ...
 TFile *f = new TFile("Histograms_WW.root","RECREATE");
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/WW.root");
...
// ********************************************************** weight
   ...
   weight = (weight/SumGenWeights)*XSec_WW*Lumi;
