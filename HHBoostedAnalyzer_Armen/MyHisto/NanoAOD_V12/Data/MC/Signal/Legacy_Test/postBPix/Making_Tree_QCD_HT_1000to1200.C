...
// ********************** PT-Mass-SFs **************************
  TFile* f_PT_Mass_SF       = new TFile("/afs/cern.ch/user/t/tumasyan/public/2023/Trigger_SFs/PT_Mass_SF_QCD/PT_Mass_2dSF_PostBPix.root");
...
void Making_Tree_QCD_HT_1000to1200()
{
...
// *********************************************************
*/ TFile *f = new TFile("Histograms_QCD_HT_1000to1200.root","RECREATE");
...
// **************************************************** Output Tree END
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/QCD_HT_1000to1200.root");
...
// ********************************************************** weight
   ...
   weight = (weight/SumGenWeights)*XSec_QCD_HT_1000to1200*Lumi;
