...
void Making_Tree_Zto2Q_4Jets_HT_200to400()
{
...
*/
 ...
 TFile *f = new TFile("Histograms_Zto2Q_4Jets_HT_200to400.root","RECREATE");
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/Zto2Q_4Jets_HT_200to400.root");
...
// ********************************************************** weight
   ...
   weight = (weight/SumGenWeights)*XSec_Zto2Q_4Jets_HT_200to400*Lumi;
