...
void Making_Histo_QCD_PT_1000to1400()
{
 TFile *f = new TFile("Histograms_QCD_PT_1000to1400.root","RECREATE");
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/MC/postEE_SFs/QCD_PT_1000to1400.root");
...
// ********************************************************** weight
   weight = (weight/SumGenWeights)*XSec_QCD_PT_1000to1400*Lumi;
