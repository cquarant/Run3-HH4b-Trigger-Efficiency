...
TH1D *_FatJet3PNetMD_Xbb  = new TH1D("FatJet3PNetMD_Xbb","FatJet3PNetMD_Xbb",100,0,1.0);
TH1D *_FatJet3PNetMD_Xbb_UDSG  = new TH1D("FatJet3PNetMD_Xbb_UDSG","FatJet3PNetMD_Xbb_UDSG",100,0,1.0);
TH1D *_FatJet3PNetMD_Xbb_C  = new TH1D("FatJet3PNetMD_Xbb_C","FatJet3PNetMD_Xbb_C",100,0,1.0);
TH1D *_FatJet3PNetMD_Xbb_B  = new TH1D("FatJet3PNetMD_Xbb_B","FatJet3PNetMD_Xbb_B",100,0,1.0);
TH1D *_FatJet3PNetMD_Xbb_B_1  = new TH1D("FatJet3PNetMD_Xbb_B_1","FatJet3PNetMD_Xbb_B_1",100,0,1.0);
TH1D *_FatJet3PNetMD_Xbb_B_2  = new TH1D("FatJet3PNetMD_Xbb_B_2","FatJet3PNetMD_Xbb_B_2",100,0,1.0);
TH1D *_FatJet3PNetMD_Xbb_Legacy  = new TH1D("FatJet3PNetMD_Xbb_Legacy","FatJet3PNetMD_Xbb_Legacy",100,0,1.0);
TH1D *_FatJet3PNetMD_Xbb_Legacy_AN  = new TH1D("FatJet3PNetMD_Xbb_Legacy_AN","FatJet3PNetMD_Xbb_Legacy_AN",100,0,1.0);
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PostBPix/TTtoLNu2Q.root");
...
//   if ( ! ( (HLT_Ele50_CaloIdVT_GsfTrkIdT_AK8PFJet230_SoftDropMass40 && fabs(lep1_Id) ==11) || (HLT_IsoMu50_AK8PFJet230_SoftDropMass40 && fabs(lep1_Id) ==13) ) )continue;
...
//  if (HLT_AK8PFJet230_SoftDropMass40_PNetBB0p06) matched_TRG_2=true;
  if( (HLT_Ele50_CaloIdVT_GsfTrkIdT_AK8PFJet230_SoftDropMass40_PNetBB0p06 && abs(lep1_Id) ==11)  || (HLT_IsoMu50_AK8PFJet230_SoftDropMass40_PNetBB0p06 && abs(lep1_Id) ==13) ) matched_TRG_2=true;
...
if(matched_TRG_1 && matched_TRG_2)
 {
 _FatJet3_pt  ->Fill(FatJet1_pt,weight);
 _FatJet3_eta ->Fill(FatJet1_eta,weight);
 _FatJet3_phi ->Fill(FatJet1_phi,weight);
 _FatJet3_eta_phi ->Fill(FatJet1_eta, FatJet1_phi,weight);
 _FatJet3_Mass ->Fill(FatJet1_Mass,weight);
 _FatJet3_MassSD ->Fill(FatJet1_MassSD,weight);
 _FatJet3_Pt_Mass  -> Fill(FatJet1_pt,FatJet1_MassSD,weight);
 _FatJet3PNetMD_Xbb ->Fill(FatJet1PNetMD_Xbb,weight);
 _FatJet3PNetMD_Xbb_Legacy ->Fill(FatJet1PNetMD_Xbb_Legacy,weight);
 _FatJet3PNetMD_Xbb_Legacy_AN ->Fill(FatJet1PNetMD_Xbb_Legacy_AN,weight);

 if(FatJet1_hadronFlavour ==0)
  _FatJet3PNetMD_Xbb_UDSG ->Fill(FatJet1PNetMD_Xbb,weight);
 if(FatJet1_hadronFlavour ==4)
  _FatJet3PNetMD_Xbb_C ->Fill(FatJet1PNetMD_Xbb,weight);
 if(FatJet1_hadronFlavour ==5)
  {
   _FatJet3PNetMD_Xbb_B ->Fill(FatJet1PNetMD_Xbb,weight);
   if(FatJet1_nBHadrons <= 1)
     _FatJet3PNetMD_Xbb_B_1 ->Fill(FatJet1PNetMD_Xbb,weight);
   if(FatJet1_nBHadrons >= 2)
    _FatJet3PNetMD_Xbb_B_2 ->Fill(FatJet1PNetMD_Xbb,weight);
  }
 }
