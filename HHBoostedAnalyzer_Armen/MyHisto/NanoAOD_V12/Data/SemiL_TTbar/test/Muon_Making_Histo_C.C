...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/PreBPix/Run2023C_Muon1.root");
//TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PreBPix/Run2023C_Muon1.root");
...
// ********************************************************** HLT Selection
   if ( ! (HLT_IsoMu27 && fabs(lep1_Id) ==13) ) continue;
...
// ********************************************************** Fill Histograms
  ...
  cout<<run<<"     "<<lumi<<"      "<<event<<endl<<endl;;
  cout<<FatJet1_pt<<"     "<<FatJet1_eta<<"      "<<FatJet1_phi<<endl;
  cout<<MET<<"     "<<lep1_Pt<<endl;
