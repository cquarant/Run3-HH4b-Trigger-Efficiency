...
//  Era = "PostEE/";
  ...
  TString JET = "FatJet2";
//  TString JET = "HBTG";
//  TString VAR = "_pt"; reb=5;
//  TString VAR = "_eta"; reb=2;
  TString VAR = "_MassSD"; reb=15;
//  TString VAR = "_Tau3OverTau2";
//  TString VAR = "_Xbb";
//  TString VAR = "_Xbb_Legacy"; reb=10;
//  TString VAR = "_Xbb_Legacy_AN";

  TString variable = JET+VAR;
//  variable="MET";
  variable = "PTjj"; reb=10;
...
// ******************************* Legend
    ...
    t1->AddText("                                                           CMS (2023 C-D JetMET) ~ 21.7 fb^{-1} #it{preliminary}");
    t1->Draw("same");
