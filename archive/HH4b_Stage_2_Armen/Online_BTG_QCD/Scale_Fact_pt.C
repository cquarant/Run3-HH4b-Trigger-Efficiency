...
void Scale_Fact_pt() {
  ...
  // TString probe_var  = "FatJet1PNetMD_Xbb_Legacy";
  // TString probeM_var = "FatJet2PNetMD_Xbb_Legacy";
  TString probe_var = "FatJet1PNetMD_Xbb_Legacy_AN";
  TString probeM_var = "FatJet2PNetMD_Xbb_Legacy_AN";
  ...
  // _MC_ProbeM_pt->GetXaxis()->SetTitle("Probe - X_{bb} (Legacy)");
  _MC_ProbeM_pt->GetXaxis()->SetTitle("Probe - T_{Xbb}");
  ...
  c1->SaveAs("Plots/Eff_PT_" + erA + ".png");
