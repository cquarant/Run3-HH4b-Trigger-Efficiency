...
// ********************** PT-Mass-SFs **************************
  TFile* f_PT_Mass_SF       = new TFile("PT_Mass_2dSF_PreBPix.root");
...
// **************************************************** Output Tree END
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/Data_2023/Legacy/PreBPix/QCD_HT_400to600.root");
   ...
   if(matched_to_AK8PFJet230_SoftDropMass40_1)
     {
      ...
      cout<<_Eff_Data->GetBinContent(bin_PT_1,bin_Mass_1)<<"         "<<_Eff_Data->GetBinError(bin_PT_1,bin_Mass_1)<<endl;
