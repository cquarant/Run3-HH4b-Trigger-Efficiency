...
OUTPUT_DIR=${SCRIPT_DIR}/output_ttbar_reweight
...
get_era_paths() {
    ...
    if [ "$process" == "ttbar" ]; then
        eff_mass_pt_path="${PROJ_ROOT}/scripts/sf_mass_pt/output_ttbar_reweight/efficiency_mass_pt_${era}_TTbar.root"
    else
        eff_mass_pt_path="${PROJ_ROOT}/scripts/sf_mass_pt/output_ttbar_reweight/efficiency_mass_pt_${era}_QCD.root"
    fi
}
