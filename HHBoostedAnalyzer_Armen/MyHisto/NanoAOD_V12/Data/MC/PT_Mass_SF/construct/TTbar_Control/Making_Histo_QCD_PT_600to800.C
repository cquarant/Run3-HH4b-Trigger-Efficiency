...
void Making_Histo_QCD_PT_600to800()
{
 TFile *f = new TFile("Histograms_QCD_PT_600to800.root","RECREATE");
...
TFile *f1 = new TFile("/eos/home-t/tumasyan/HHTo4B/MC/postEE_SFs/QCD_PT_600to800.root");
...
// ********************************************************** weight
   weight = (weight/SumGenWeights)*XSec_QCD_PT_600to800*Lumi;
